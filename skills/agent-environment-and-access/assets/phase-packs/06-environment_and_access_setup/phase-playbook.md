...
Local phase pack for `environment_and_access_setup`. Use this file from the owning support skill folder; use the referenced central assets as the source of truth for executable templates, rubrics, validator rules, and examples.
...
- Checklist: `skills/agent-build-managed-agentops/assets/checklists/environment-access-checklist.md`
- Rubric: `skills/agent-build-managed-agentops/assets/rubrics/environment-access-readiness-rubric.yaml`
- Validator rule: `skills/agent-build-managed-agentops/assets/validator-rules/environment_and_access_setup.yaml`
- Golden-path example: `skills/agent-build-managed-agentops/assets/examples/golden-path/06-environment-progression-gate.yaml`
