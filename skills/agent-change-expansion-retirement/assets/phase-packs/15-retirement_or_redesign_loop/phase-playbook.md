...
Local phase pack for `retirement_or_redesign_loop`. Use this file from the owning support skill folder; use the referenced central assets as the source of truth for executable templates, rubrics, validator rules, and examples.
...
- Checklist: `skills/agent-build-managed-agentops/assets/checklists/retirement-redesign-checklist.md`
- Rubric: `skills/agent-build-managed-agentops/assets/rubrics/retirement-redesign-rubric.yaml`
- Validator rule: `skills/agent-build-managed-agentops/assets/validator-rules/retirement_or_redesign_loop.yaml`
- Golden-path example: `skills/agent-build-managed-agentops/assets/examples/golden-path/15-retirement-redesign-review.yaml`
