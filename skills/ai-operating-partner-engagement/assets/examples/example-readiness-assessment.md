...
Workflow: Monthly operational report preparation

| Dimension | Score | Evidence | Gap/Fix |
|---|---:|---|---|
| Business value | 4 | Report consumes several team-days monthly | Quantify exact time |
| Workflow clarity | 4 | Steps are repeatable and owner is known | Validate exceptions |
