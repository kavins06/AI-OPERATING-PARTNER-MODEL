...
- Ask operators what a beginner gets wrong.
- Ask admins where templates, checklists, reports, and informal notes live.
...
The map is strong only if it links knowledge to:
...
If tacit judgment is central, use `tacit-to-explicit-knowledge-capture` next.
